...
- **IP range classification**: Each source IP range is automatically tagged based on authentication results:
  - ✅ **Legitimate** — Has ever passed DKIM+SPF authentication. Holding a DKIM private key proves this is an authorized sender.
  - 🛡️ **Blocked** — No valid keys, all rejected. Attackers being stopped by your policy.
  - 🔴 **Threat (Unblocked)** — No valid keys and zero passes, yet delivered. Someone is spoofing your domain and getting through.
...
└─ (125 keys per locale, 12 languages)
```
